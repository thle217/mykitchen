...
-- Thời gian đã tạo: Th3 15, 2023 lúc 07:28 PM
...
INSERT INTO `discounts` (`discount_id`, `title`, `code`, `percent`, `condition`, `start_date`, `end_date`, `description`) VALUES
(6, 'Giảm 10% cho đơn hàng trên 500k', '10percent', 10, 500000, '2023-03-16', '2023-03-20', NULL),
(7, 'Giảm 15% cho đơn hàng trên 1 triệu', '15percent', 15, 1000000, '2023-03-16', '2023-03-20', NULL),
(8, 'Giảm 20% cho đơn hàng trên 2 triệu', '20percent', 20, 2000000, '2023-03-16', '2023-03-20', NULL);
...
(1, 1, 'Diệp An', 'Nữ', '2000-10-09', '0901234567', '456 Nguyễn Trãi', 'phường 2', 'quận 5', 'TPHCM', 'diepan001', '$2b$10$7Yx7w.o7zQoGOb3TTMW.R.FccF73NZh6oipSfgqdmtrmHpPJo7bdm', 'diepan001@gmail.com'),
(2, 1, 'Hoa Hoa', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'hoahoa001', '$2b$10$bXUJTKas7sx8aAirQE39TOsnftxrLSbsEIEvAa3JmAJK8NV..wJsm', 'hoahoa001@gmail.com'),
(3, 1, 'Phan Khải', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'phankhai001', '$2b$10$GsOdbLNlh33JWgPiBkEDKe8hKSUaAyUg4lAknm4yI19ZNWa1zedri', 'phankhai001@gmail.com'),
(7, 3, 'Admin MyKitchen', 'Nam', '1998-06-12', '0126123123', '123 Trần Hưng Đạo', 'phường 7', 'quận 5', 'TPHCM', 'admin01', '$2b$10$SFI70As4C5zw4tI7pwQe9ux7F1zM9CpZgOnMkdo2Sc8ZvlcgZraQW', NULL),
(12, 2, 'Nhân viên 01', 'Nam', '1997-08-12', '0126123456', '123/45 Nguyễn Văn Cừ', 'phường 3', 'quận 1', 'TPHCM', 'nhanvien01', '$2b$10$NvY9KSpUMGVC1yPyWjuYrOuv3YleJltkIwc9PviwI7irqA3tuSbc.', NULL);
